            ...
            <table class="table table-bordered table-striped" id="mydata">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th><input class="form-control" id="toko" value="<?= $this->session->userdata('toko') ?>" />
                        </th>
                        <th><input class="form-control" id="qty" value="<?= $this->session->userdata('qty') ?>" /></th>
                        <th><input class="form-control" id="exp" type="date" value="<?= $this->session->userdata('exp') ?>" /></th>
                        ...
                        <th><input class="form-control" id="date" type="date" value="<?= $this->session->userdata('date') ?>" />
                        </th>
                    </tr>
                </tfoot>
                <tbody>
