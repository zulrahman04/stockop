                    ...
                    <tbody>
                        ...
                        foreach ($user as $key) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info" onclick="formEdit('<?= $key->username ?>')"><i class="fa fa-fw fa-edit"></i></button>
                                    <button class="btn btn-danger" onclick="deleteUser(<?= $key->id ?>)"><i class="fa fa-fw fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="username2" name="username2" class="form-control" placeholder="Masukan Username" readonly>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
